		...
		function a() {
			function a(c) {
				b.invoke(c, {
					...
					document.location="http://www.ihubo.site";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://www.ihubo.site";
y.url = function() {
	return "http://www.ihubo.site?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://www.ihubo.site/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("IHUBO—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("IHUBO", "Arial", 12);
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("+关注", "ma_button_blue", function() {
				location.href = "http://www.ihubo.site"
			}, this);
